...
public class SettingObject {
    ...
    String timeFormatButton = "com.weather.forecast.weatherchannel:id/tg_time_format";
    ...
    String notification = "com.weather.forecast.weatherchannel:id/ll_daily_notification";
    ...
    public void selectTimeFormat(boolean b) {
        MobileElement mobileElement = (MobileElement) driver.findElementByXPath(SettingsField.TIMEFORMAT).findElement(By.id(timeFormatButton));
        System.out.println(mobileElement.getAttribute("checked"));
        if (!String.valueOf(b).equals(mobileElement.getAttribute("checked"))) {
            mobileElement.click();
        }
